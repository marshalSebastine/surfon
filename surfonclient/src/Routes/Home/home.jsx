    ...
    <>
        ...
        <div className="car-logo-container">
            ...
            <ActivityInfo header={'Ocean Swim'}
                          ...
                          buttontext={'Book Class'}
                          buttonlink={'/oceanswimming'}
                          faqbttn={false}
                          />
            <div className="activity-bg" style={{backgroundImage: `url(${oceanswimming})`,backgroundPosition: 'center top'}}/>
            <ActivityCard header={'Camping'}
                          activityinfotxt={'Chennai’s favorite children outing activity. Ideal for kids of all ages. Customised, exclusive,. For Friends & Family groups.'}
